...
export default function ModalComp({ open, setOpen, cardsArray, handleClose }) {
  ...
  return (
    <React.Fragment>
      ...
      >
              ...
              <div key={index} className="d-flex w-100">
                <Button
                  style={{
                    ...
                    border: isSelected?.id === item?.id ? "1px solid blue" : "",
                  }}
                  className="text-dark d-flex px-4"
                  onClick={(e) => handleWeek(e, item)}
                >
                  {item.title}
                </Button>
              </div>
        ...
        <DialogActions>
          <Button
            className=" d-flex px-4 text-white"
          ...
          <div className="d-none">
            {isDone && (
              <TabsComp gotTheAllCards={cardsArray} weekName={isSelected} />
            )}
          </div>
        </DialogActions>
      </Dialog>
